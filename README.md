...
**[hello-rails-react]**  is a web application that serves as a test for the Microverse Final Capstone project, which teaches how to use react in a rails app.
...
```sh
  cd my-folder
  git clone "https://github.com/danielochuba/hello-rails-react.git"
```
### Install
