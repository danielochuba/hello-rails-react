...
**[Messages App]**  is a web application that serves as a test for the Microverse Final Capstone project, which teaches how to use react in a rails app.
